    ...
    <>
      <style jsx>{`
        ...
        @keyframes glow {
          ...
          50% {
            box-shadow: 0 0 10px rgba(96, 165, 250, 0.5), 0 0 15px rgba(59, 130, 246, 0.3);
          }
          100% {
            box-shadow: 0 0 3px rgba(96, 165, 250, 0.3);
          }
        ...
        .section-container::before {
          ...
          width: 100%;
          height: 100%;
          background: linear-gradient(135deg, rgba(99, 102, 241, 0.05), rgba(96, 165, 250, 0.05));
        ...
        .section-container::after {
          ...
          right: -2px;
          bottom: -2px;
          background: linear-gradient(45deg, #6366f1, #60a5fa, #38bdf8, #6366f1);
          border-radius: inherit;
          z-index: -1;
          opacity: 0;
          transition: opacity 0.5s ease;
